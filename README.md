...
- An image from the camera where the object is visible
- The 3D coordinates of each of the object's corners in the reference frame (e.g. world frame)
- The 3x3 camera matrix saved as a Numpy array
- The camera distortion coefficients saved as a Numpy array 
